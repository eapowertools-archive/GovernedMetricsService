		...
		return new Promise(function(resolve, reject)
		{
			...
			.then(function(config)
			{
				...
				.then(function(layout)
				{
					...
					{
						measureInfo = measure.qMeta.title + ':' + measure.qInfo.qId;
				...
				.then(function(layout)
				{
					...
					{
						dimInfo = dimension.qMeta.title + ':' + dimension.qInfo.qId;
				...
				.then(function()
				{
					...
					{
						logger.error('deleteAllMasterItems::SaveObjects Failure::' + error, {module: 'deletemetrics'});
