...
var deleteMetrics = {
    deleteAllMasterItems: function (appId) {
        return new Promise(function (resolve, reject) {
                logger.info('deleteAllMasterItems::Deleting all MasterItem dimensions and measures from app: ' + appId, {
                    module: 'deletemetrics'
                });
                var stuff = {};
                stuff.appId = appId;
                ...
                session.open()
                        ...
                        return Promise.map(mList, function (listItem) {
                            return stuff.app.destroyMeasure(listItem.qInfo.qId)
                                .then(function (success) {
                                    ...
                                    logger.info('deleteAllMasterItems::destroyMeasure::' + measureInfo + ' succeeded', {
                                        module: 'deletemetrics'
                                    });
                                    return listItem;
                                });
                    ...
                    .then(function (measureArray) {
                        ...
                        logger.info("Destroyed " + measureArray.length + " measures from " + stuff.appRef.name, {
                            module: 'deletemetrics',
                            app: stuff.appRef.name
                        });
                        logger.info("Waiting for notification service to inform that the repository is clean", {
                            module: 'deletemetrics',
                            app: stuff.appRef.name
                        });
                    })
                        ...
                        return Promise.map(dList, function (listItem) {
                            return stuff.app.destroyDimension(listItem.qInfo.qId)
                                .then(function (success) {
                                    ...
                                    logger.info('deleteAllMasterItems::destroyDimension::' + dimInfo + ' succeeded', {
                                        module: 'deletemetrics'
                                    });
                                    return listItem;
                                });
                    ...
                    .then(function (dimensionArray) {
                        logger.info("Destroyed " + dimensionArray.length + " measures from " + stuff.appRef.name, {
                            module: 'deletemetrics',
                            app: stuff.appRef.name
                        });
                        logger.info("Waiting for notification service to inform that the repository is clean", {
                    ...
                    .then(function () {
                        logger.info('deleteAllMasterItems::saveObjects::Master Items removed.', {
                            module: 'deletemetrics'
                        });
                        var res = {
                        ...
                        session.close()
                            .then(function () {
                                logger.info('deleteAllMasterItems::Engine connection terminated', {
                                    module: 'deletemetrics'
                                });
                                resolve(res);
                            });
                    ...
                    .catch(function (error) {
                        session.close()
                            .then(function () {
                                logger.error('deleteAllMasterItems::enigma error::' + error, {
                                    module: 'deletemetrics'
                                });
            ...
            .catch(function (error) {
                logger.error('deleteAllMasterItems::Config error::' + error, {
                    module: 'deletemetrics'
                });
                reject(new Error(error));
            });
