                ...
                .then(function(global) {
                    ...
                    return global.openDoc(appId, '', '', '', true)
                        ...
                        .then(function(resultArray) {
                            ...
                            logger.info('Please wait while the repo catches up, ownership changes have been applied, and metric publish is determined.', { module: "objectManagement", app: appRef.name });
                            return ('Done!');
                        })
