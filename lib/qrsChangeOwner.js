...
var qrsChangeOwner = {
    changeAgent: function() {
        ...
        return new Promise(function(resolve, reject) {
            ...
            var path = "/app/object";
            path += "?filter=owner.userId eq '" + config.default.repoAccountUserId + "' and owner.userDirectory eq '";
            path += config.default.repoAccountUserDirectory + "' and (objectType eq 'dimension' or objectType eq 'measure')";
        ...
        return new Promise(function(resolve, reject) {
            ...
            sequence = sequence
                ...
                .then(function(selection) {
                    ...
                    var path = "https://" + config.default.hostname + ":" + config.default.qrsPort + "/qrs/selection";
