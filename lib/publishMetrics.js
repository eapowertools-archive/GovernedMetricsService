...
var publishMetrics = 
{
    publishMetrics : function(appRef, appId)
    {
        return new Promise(function(resolve, reject)
        {
            ...
            logger.info("Searching published apps for dimensions and measures with the tag 'gms'", {module:"publishMetrics",app: appRef.name});
            ...
            .then(function(appObjects)
            {
                ...
                {
                    logger.info(appRef.name + " is not a published app, therefore, no metrics will be published until the app is published.  Metrics should appear in unpublished apps.", {module:"publishMetrics",app: appRef.name});
                    resolve(appRef.name + " is not a published app, therefore, no metrics will be published until the app is published.  Metrics should appear in unpublished apps.");
                }
            })
