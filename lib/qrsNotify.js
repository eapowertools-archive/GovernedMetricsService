...
var qrsNotify = {
    setNotification: function()
    {
        ...
        return new Promise(function(resolve, reject)
        {
            ...
            path += "&filter=owner.userId eq '" + config.default.repoAccountUserId + "' and owner.userDirectory eq '" + config.default.repoAccountUserDirectory + "'";
            var body = "http://" + config.default.hostname + ":" + config.default.port + "/masterlib/notifyme";
